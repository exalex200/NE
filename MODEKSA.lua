...
sudo_users = {SUDO,1702918704,bot_id}
...
if tonumber(user_id) == tonumber(1702918704) then  
var = true  
...
if SudoBot(msg) then
local bl =  '-  Welcome exالمطور الاساسي \n سورس نيغا \n يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/EX_CHAN) '
local keyboard = {
	{'•معلومات الكيبورد•'},
	  {'•ضع اسم للبوت•'},
...
send(msg.sender_user_id_, msg.id_,' Welcome ex\n سيتم الرد عليك قريبا')
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'EX_CHAN')..')'
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'EX_CHAN')..') '
status  = '\n تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'• العضو> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'EX_CHAN')..') \n •'..MODEKSA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/EX_CHAN)}\n•["..MODEKSA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/EX_CHAN)}\n• الملصق الذي ارسلته تم منعه من القروب \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@EX_CHAN','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
Text = [[
╭• [𝐸𝑋 𝐶𝐻𝐴𝑁𝑁𝐸𝐿](t.me/EX_CHAN) •╮
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'سورس اكس' or text == 'اريد بوت تمبلر' or text == 'سورس اكس' then
Text = [[
•- DEV @PC_SS مبرمج بوتات•
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == '@PC_SS' or text == '@EX_CHAN' or text == 'اليكس' then
Text = [[
@PC_SS هذا مطور سورس اكس
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'EX_CHAN')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'EX_CHAN')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' بواسطه > ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'EX_CHAN')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'EX_CHAN')..') \n*تم قفـل الالعاب*\n')  
end,nil)   
...
if result.sender_user_id_ == tonumber(1702918704) then
...
local UserName = (b.username_ or "EX_CHAN")
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n• العضو > ['..result.title_..'](t.me/'..(text1[3] or 'EX_CHAN')..')'..'\n تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/EX_CHAN) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [𝗛𝗜 𝗘𝗫  - SoUrCe](https://t.me/EX_CHAN)
]]
...
send(msg.chat_id_,0,"•العضو : {["..data.first_name_.."](T.ME/EX_CHAN)}\n•["..MODEKSAAbot.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
return false
